...
from ibm_network.dml.ast import DmlDecimal, DmlField, DmlRecord
...
def test_parsed_record_picks_csv_delimited() -> None:
    rec = DmlRecord(fields=(DmlField(name="id", type=DmlDecimal(precision=10)),))
